<?php
/**
 * Template Name: Community Tips Page
 * Template for /community-tips/ - Shows other users' tips
 */
...
<main id="main" class="site-main">
    <div class="page-wrapper" style="max-width: 1400px; margin: 0 auto; padding: 40px 20px;">
        <?php
        if ( shortcode_exists( 'ol_community_tips' ) ) {
            echo do_shortcode( '[ol_community_tips]' );
        } else {
